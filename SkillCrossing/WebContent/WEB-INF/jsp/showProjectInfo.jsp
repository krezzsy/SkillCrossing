								...
								<form name="adminForm" id="adminForm" class="form-horizontal">
									<div style="text-align: center; padding: 85px;">
										...
										<table class="table table-striped table-bordered">
											<thead>
												<tr>
													<th class="list-title" id="tableOrdering"><a
														class="hasTooltip"
														title="&lt;strong&gt;Title&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Login</a>
													</th>


													<th class="list-author" id="tableOrdering3"><a
														class="hasTooltip"
														title="&lt;strong&gt;Author&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Password</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Name</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Surname</a>
													</th>
												</tr>
											</thead>
											...
											<tbody>
												...
												<c:forEach var="client" items="${requestScope.clients}">
													<tr class="cat-list-row0">
														<td class="list-title"><c:out value="${client.login}" /></td>
														<td class="list-hits"><c:out
																value="${client.password}" /></td>
														<td class="list-hits"><c:out value="${client.name}" /></td>
														<td class="list-hits"><c:out
																value="${client.surname}" /></td>
									...
									<div style="text-align: center; padding: 85px;">
										<h2 align="center">Specialist Info</h2>
										<table class="table table-striped table-bordered">
											<thead>
												<tr>
													<th class="list-title" id="tableOrdering"><a
														class="hasTooltip"
														title="&lt;strong&gt;Title&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Name</a>
													</th>


													<th class="list-author" id="tableOrdering3"><a
														class="hasTooltip"
														title="&lt;strong&gt;Author&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Surname</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Speciality</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Experience</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Email</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Website</a>
													</th>

													<th class="list-hits" id="tableOrdering4"><a
														class="hasTooltip"
														title="&lt;strong&gt;Hits&lt;/strong&gt;&lt;br /&gt;Select to sort by this column">Technologies</a>
													</th>
												</tr>
											</thead>
											...
											<tbody>
												...
												<c:forEach var="specialist"
													...
													<tr class="cat-list-row0">
														<td class="list-title"><c:out
																value="${specialist.name}" /></td>
														<td class="list-hits"><c:out
																value="${specialist.surname}" /></td>
														<td class="list-hits"><c:out
																value="${specialist.speciality}" /></td>
														<td class="list-hits"><c:out
																value="${specialist.experience}" /></td>
														<td class="list-hits"><c:out
																value="${specialist.email}" /></td>
														<td class="list-hits"><c:out
																value="${specialist.website}" /></td>
														<td class="list-hits"><c:out
																value="${specialist.technologies}" /></td>
