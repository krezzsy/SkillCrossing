										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="https://blog.codinghorror.com/content/images/uploads/2009/06/6a0120a85dcdae970b0120a86e21f3970b-pi.png"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/bundle-offer/book-bundle-offer">
															<span itemprop="name">Regular Expressions Cookbook
																O'Reilly</span>
														</a>
													</h2>
													...
													<p class="dc-item-desc" itemprop="description">A book
														teaching regular expressions in everyday text-finding
														scenarios</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="http://www.uran1980.com/myfolio/wp-content/uploads/2009/09/book-cover-pro-php.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/bundle-offer/games-bundle-offer">
															<span itemprop="name">Pro PHP</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">This
														book is for intermediate programmers interested in
														building Ajax web applications using jQuery and PHP</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="http://meigetel.com/wp-content/uploads/2015/06/51gOvSKJEiL.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/bundle-offer/joomla-bundle-theme">
															<span itemprop="name">Building The Infrastructure
																For Cloud Security</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
														<meta itemprop="priceCurrency" content="USD">
														<strong itemprop="price"> 28.50$</span>
														</strong>

													</div>
													<p class="dc-item-desc" itemprop="description">This
														book provides a comprehensive look at the various facets
														of cloud security</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url" href="/index.php/store/games/batman">
													<img itemprop="image"
													src="https://images-na.ssl-images-amazon.com/images/I/51zEg13Zu7L._AC_UL320_SR254,320_.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url" href="/index.php/store/games/batman">
															<span itemprop="name">Cryptography with Java </span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
														<meta itemprop="priceCurrency" content="USD">
														<strong itemprop="price"> 31.00$</span>
														</strong>

													</div>
													<p class="dc-item-desc" itemprop="description">Java
														Cryptography teaches you how to write secure programs
														using Java's cryptographic tools</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url" href="/index.php/store/games/mad-max">
													<img itemprop="image"
													src="http://meigetel.com/wp-content/uploads/2015/06/51tjKL3FVjL.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url" href="/index.php/store/games/mad-max">
															<span itemprop="name">Cloud Architecture Patterns
																O'Reilly</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
														<meta itemprop="priceCurrency" content="USD">
														<strong itemprop="price"> 22.00$</span>
														</strong>

													</div>
													<p class="dc-item-desc" itemprop="description">With the
														information in this book, you’ll be able to make informed
														decisions for designing effective cloud-native
														applications</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="http://4.bp.blogspot.com/-UjcIH0FqzM8/VBQN4Ryp1bI/AAAAAAAACtk/FJS1Kem_bCc/s1600/51kfTybs36L.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/games/batman-the-killing-joke">
															<span itemprop="name">Swift Programming</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">Swift is
														a new programming language for iOS and OS X apps that
														builds on the best of C and Objective-C, without the
														constraints of C compatibility</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													itemprop="image"
													src="http://www.nicklevine.org/lisp-book/cover.png"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															...
															itemprop="name">Lisp O'Reilly</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">Lisp is
														a family of computer programming languages based on formal
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													itemprop="image"
													src="http://images.shorturllink.com/userimg/view/image/cache/data/p/1558000000/1558743483-500x500.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															...
															itemprop="name">XML Programming With AB and ASP</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">This
														book is aimed toward seasoned Web or general application
														developers as a guide for developing sophisticated,
														real-world XML solutions</p>
