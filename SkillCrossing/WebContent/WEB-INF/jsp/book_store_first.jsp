											...
											<ul class="l2">
												<li class="item653 grouped first"><a class="subtitle"
													...
													<ul class="l2">
														...
														<li class="item492"><a href="#">${cooperation }</a></li>
														<li class="item467"><a
										...
										<div id="txmod_314" class="xpert-captions">
											<div class="xc-block xc-slide">
												<div class="xc-overlay">
													<div class="xc-details">
														<h5>
															<a href="#" target="_self"> ${modern_technologies} </a>
														</h5>
											...
											<div class="xc-block xc-slide">
												<div class="xc-overlay">
													<div class="xc-details">
														<h5>
															<a href="#" target="_self"> ${professional_team } </a>
														</h5>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="http://ecx.images-amazon.com/images/I/51xqCdemDoL._SX373_BO1,204,203,200_.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/bundle-offer/book-bundle-offer">
															<span itemprop="name">Java Server Pages O'Reilly</span>
														</a>
													</h2>
													...
													<p class="dc-item-desc" itemprop="description">Java
														Server Pages (JSP) is a server side technology for
														developing dynamic web pages</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="http://ecx.images-amazon.com/images/I/51DG8dQ4TiL._SX383_BO1,204,203,200_.jpg"
												...
												<figcaption class="caption">
													...
													<p class="dc-item-desc" itemprop="description">The
														Spring Framework is an application framework and inversion
														of control container for the Java platform</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="http://lh4.ggpht.com/_0j4bzarlOBg/TDQpgO3Xg4I/AAAAAAAABL8/90En1S_KAOk/image3%5B1%5D.png?imgmax=800"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/bundle-offer/joomla-bundle-theme">
															<span itemprop="name">JavaScript: The Good Parts
																O'Reilly</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url" href="/index.php/store/games/batman">
													<img itemprop="image"
													src="http://www.croftsoft.com/library/books/ajgp/cover_359x475.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url" href="/index.php/store/games/batman">
															<span itemprop="name">Java Game Programming</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">Java is
														a general-purpose language, so nothing prevents it from
														being used for writing games</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url" href="/index.php/store/games/mad-max">
													<img itemprop="image"
													src="http://ecx.images-amazon.com/images/I/41E-DkkpPtL.jpg"
												...
												<figcaption class="caption">
													...
													<p class="dc-item-desc" itemprop="description">Python
														is an increasingly popular language, and it's also a
														favorite language teaching first time programmers</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													<img itemprop="image"
													src="https://images-na.ssl-images-amazon.com/images/I/51L7znS4rjL._SX379_BO1,204,203,200_.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															href="/index.php/store/games/batman-the-killing-joke">
															<span itemprop="name">Oracle PL/SQL Programming</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">This
														book is the definitive reference on PL/SQL, considered
														throughout the database community to be the best Oracle
														programming book available</p>
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													itemprop="image"
													src="http://cdn.usefulstuff.io/2012/11/big_data_glossary.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															...
															itemprop="name">Big Data Glossary O'Reilly</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
										...
										<div class="dc-item thumbnail" itemscope
											...
											<figure>
												<a itemprop="url"
													...
													itemprop="image"
													src="http://freeebooksearch.net/pics/9ca41_c23_51A7JF9EMPL.jpg"
												...
												<figcaption class="caption">
													...
													<h2>
														<a itemprop="url"
															...
															itemprop="name">Network Programming in C#</span>
														</a>
													</h2>
													<div class="dc-price text-muted" itemprop="offers"
														itemscope="" itemtype="http://schema.org/Offer">
													...
													<p class="dc-item-desc" itemprop="description">This
														book helps newcomers get started with a look at the basics
								...
								<div style="margin-top: 24px;">
									...
									<ul class="social-icons clearfix">
										...
										<li class="twitter"><a target="_blank"
											href="https://github.com/krezzsy"><i class="icon-twitter"></i></a></li>
										...
										<li class="ytube"><a target="_blank"
											href="https://github.com/krezzsy"><i class="icon-youtube"></i></a></li>
